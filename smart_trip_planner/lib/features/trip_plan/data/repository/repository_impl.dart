...
class ItineraryRepositoryImpl implements ItineraryRepository {
  ...
  @override
  Future<void> saveItineraryOffline(ItineraryEntity entity) async {
    final box = await Hive.openBox<ItineraryHiveModel>('itineraries');
    final model = mapToHiveModel(entity);
    await box.add(model);
  }
}
